...
export default function CheckEmailPage() {
  ...
  // opsional: allow redirect target from query (?redirect=/main/dashboard)
  ...
  const checkVerifiedOnce = async () => {
    const supabase = getSupabaseBrowser()

    // getUser lebih “source of truth” dibanding getSession untuk data user
    ...
    setStatus("waiting")
    setMessage("Belum terverifikasi. Setelah klik tautan di email, halaman ini akan otomatis lanjut.")
    return false
  }
  ...
  useEffect(() => {
    ...
    const start = async () => {
      ...
      // polling tiap 3 detik (cukup nyaman, nggak terlalu spam)
